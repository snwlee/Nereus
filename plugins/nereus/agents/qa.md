...
model: inherit
tools: Read, Grep, Glob, Bash, Write, Edit, mcp__plugin_ecc_chrome-devtools__take_screenshot, mcp__plugin_ecc_chrome-devtools__navigate_page, mcp__plugin_ecc_chrome-devtools__list_console_messages
---
