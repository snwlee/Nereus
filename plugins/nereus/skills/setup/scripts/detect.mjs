...
export const TOOLS = [
  ...
  { bin: "agy", label: "Antigravity CLI (Gemini 2차 의견, 개인 무료 티어)", required: true, group: "코어", install: { darwin: "brew install --cask antigravity-cli", win32: "irm https://antigravity.google/cli/install.ps1 | iex", linux: "curl -fsSL https://antigravity.google/cli/install.sh | bash" }, note: "설치 후 터미널에서 `agy` 한 번 실행해 Google 로그인" },
